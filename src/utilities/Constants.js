...
//new
export const AWS_API_GATEWAY_UPLOAD_IMAGE_URL = "https://ojmp9bfa2k.execute-api.us-east-1.amazonaws.com/dev/friends-capstone-infra-s3-images/originals/{filename}";